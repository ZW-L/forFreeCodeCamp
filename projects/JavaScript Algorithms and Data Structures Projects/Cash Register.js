...
function checkCashRegister(price, cash, cid) {
  // var tags = ['PENNY', 'NICKEL', 'DIME', 'QUARTER', 'ONE', 'FIVE', 'TEN', 'TWENTY', 'ONE HUNDRED']
  // var prices = [0.01, 0.05, 0.1, 0.25, 1, 5, 10, 20, 100]
  var tags = ['ONE HUNDRED', 'TWENTY', 'TEN', 'FIVE', 'ONE', 'QUARTER', 'DIME', 'NICKEL', 'PENNY'] 
  var prices = [10000, 2000, 1000, 500, 100, 25, 10, 5, 1]
  var totals = cid.map((v, i) => Math.round(v[1]*100/prices[8-i]))
  console.log(totals)
